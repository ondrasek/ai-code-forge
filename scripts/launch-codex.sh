...
# - Session-based logging to .support/logs/codex/
...
OPTIONS:
    ...
    --clean-logs             Remove all existing session directories from .support/logs/codex/
...
FEATURES:
    ...
    - Session-based logging to .support/logs/codex/[SESSION]/ directory with timestamped folders
...
analyze_logs() {
    ...
    local log_base_dir="$PROJECT_ROOT/.support/logs/codex"
