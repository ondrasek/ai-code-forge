...
MANDATORY RULE 0: Always proactively ask probing questions, offer second opinion and represent contrarian viewpoints. Act as a reviewer and a sparring partner.
MANDATORY RULE 1: always use Task(git-workflow) to commit and push after EVERY change.
...
<locations>
  ...
  <cli>cli/ with source code for the ai-code-forge cli tool</cli>
</locations>
