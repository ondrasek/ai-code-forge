...
"$postCreateScriptsDir/configure-git-user.sh"
"$postCreateScriptsDir/configure-git-credentials.sh"
"$postCreateScriptsDir/configure-git-safety.sh"
...
"$postCreateScriptsDir/validate-worktree-environment.sh"
"$postCreateScriptsDir/configure-bash-worktree.sh"
"$postCreateScriptsDir/configure-zsh-worktree.sh"
